...
<p>Executando <b>frontend</b>: Dentro da pasta frontend do repositório utilize o comando `npm start`<br></p>
<p>Executando <b>backend</b>: Na pasta raiz do repositório utilize o comando `node start`</p>
